  ...
  events: [
    {
      ...
      desc: {
        zh: '手工川 AI 沙龙 EP01（南川主理）开放麦环节，主题「如何用 Agent 实现全自动化创作」，epark 海淀花园路社区 50 人场；与另外 4 位嘉宾（伟园长、雪亮律师、小红帽、张竹青）同台。我讲的是「自驾人在机器人生存指南」 — 与上次深蓝学院同题，但内容做了重写与扩充',
        en: 'Open Mic at Forge AI Salon EP01 (hosted by NanChuan), themed on Agent-driven automated content creation, at Beijing\'s epark Haidian (50-seat venue). Shared alongside four fellow speakers (伟园长, 雪亮律师, 小红帽, 张竹青); my talk — "Self-Driving People\'s Robotics Survival Guide" — kept the Shenlan Academy title but was rewritten and expanded for this round',
      },
      links: [
