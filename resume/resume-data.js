const RESUME_DATA = {
  ...
  person: {
    ...
    focus: '机器人系统技术负责人\n系统工程 · 数据评测',
    location: '北京',
    summary: '7 年多自动驾驶与机器人研发经验，持续把算法能力转化为可交付、可验收的机器人系统。作为小米自动驾驶团队初创成员，从 0 到 1 组建最多 9 人的感知系统团队，以量产工程、质量和性能机制支撑百人级研发协作；2025 年主动转入机器人业务，负责整机系统与机器人任务交付，工作进一步覆盖模型部署、数据评测、具身模型后训练和真机适配。下一步希望在机器人系统工程或数据评测方向承担更大 scope，继续深入一线技术，推动系统稳定交付，并用数据和评测加快模型与系统迭代。',
  },
  contacts: {
