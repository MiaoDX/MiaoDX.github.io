const RESUME_DATA = {
  ...
  person: {
    ...
    location: '北京',
    summary: '7 年多自动驾驶与机器人研发经验，主线是把算法能力变成可交付、可验收的完整系统。曾从 0 到 1 组建最多 9 人的感知系统团队，以量产工程、质量和性能机制支撑百人级研发协作；2025 年主动转入机器人业务，负责整机与完整任务交付，并延伸到模型部署、数据评测、具身模型微调和真机适配。下一步希望作为 hands-on 机器人系统技术负责人，对技术路线、团队建设和完整任务结果负责。',
  },
  contacts: {
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        '模型部署与规模化迭代：负责 VLN 从传感器接入、云端或板端推理到机器人运控的真机部署；同时负责仿真数据管线与云端批量评测，扩展到百实例级并行，单实例数据生产吞吐提升约 2 倍。',
