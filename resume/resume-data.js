const RESUME_DATA = {
  ...
  person: {
    ...
    location: '北京',
    summary: '7 年自动驾驶与机器人研发经验，长期在算法、系统工程与组织协作的交界处，把单点能力变成可交付、可验收、可持续迭代的复杂系统。曾从 0 到 1 组建 9 人感知系统团队；2025 年主动转向机器人研发，现聚焦机器人完整任务、数据评测与 Agent 系统。',
  },
  contacts: {
  ...
  projects: [
    ...
    },
    {
      ...
      desc: '面向 Agent 软件开发的可移植工作流工具包。为 Claude Code 与 Codex 组织目标澄清、计划、执行、验证以及长期维护与简化，将长期 Agentic Coding 实践整理为可复用 Skill 与仓库约定，并用于部门内部的方法推广与工程实践分享。',
    },
  ],
  education: [
    {
